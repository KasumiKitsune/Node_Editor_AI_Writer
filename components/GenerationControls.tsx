...
const CoreControls: React.FC<Pick<GenerationControlsProps, 'onOpenHelp' | 'onOpenAssets' | 'targetWordCount' | 'onWordCountChange' | 'onAdjustWordCount' | 'isAnyTaskRunning' | 'onToggleAssistant' | 'isAssistantOpen'>> = ({
    onOpenHelp,
    onOpenAssets,
    targetWordCount,
    onWordCountChange,
                 ...
                 <div className="flex flex-row items-end gap-3">
                     <div className="relative z-30 flex flex-col items-end pointer-events-auto">
                        ...
                        {isAnyTaskRunning ? (
                            <button
                                onClick={onCancel}
                                className="w-16 h-16 bg-red-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-red-500 transition-all duration-300 transform pointer-events-auto animate-scale-in"
